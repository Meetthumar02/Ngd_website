<?php
/**
 * Template Name: White Label Software Development Company
 * Description: High-converting White Label Software Development landing page for NGD Technolab (100% Native Elementor)
 */
...
<main class="wl-page-wrapper wl-software-dev-page">
<?php
while ( have_posts() ) :
    the_post();
    the_content();
