<?php
/**
 * Template Name: White Label Mobile App Development
 * Description: High-converting White Label Mobile App Development landing page for NGD Technolab (Elementor-compatible)
 */
