	...
	protected function render() {
		...
		if ( class_exists( 'Woocommerce' ) && defined( 'YITH_WCWL' ) ) {
			...
			if ( function_exists( 'porto_wishlist' ) ) {
				...
				echo '<a href="' . esc_url( YITH_WCWL()->get_wishlist_url() ) . '" aria-label="' . esc_attr__( 'Wishlist', 'porto-functionality' ) . '" title="' . esc_attr__( 'Wishlist', 'porto-functionality' ) . '" class="my-wishlist"><i class="' . esc_attr( $icon_cl ) . '"></i>' . ( $porto_settings['wl-offcanvas'] ? '<span class="wishlist-count">' . intval( $wc_count ) . '</span>' : '' ) . '</a>';
			}
