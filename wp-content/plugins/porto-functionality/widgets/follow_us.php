...
class Porto_Follow_Us_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="<?php echo esc_attr( $class_escaped ); ?>">
			...
			if ( $whatsapp ) :
				?>
				<a href="whatsapp://send?text=<?php echo esc_attr( $whatsapp ); ?>" <?php echo porto_filter_output( $nofollow_escaped ); ?> target="_blank" <?php echo esc_attr( $tooltip_escaped ); ?>title="<?php esc_attr_e( 'WhatsApp', 'porto-functionality' ); ?>" class="share-whatsapp" style="display:none"><?php esc_html_e( 'WhatsApp', 'porto-functionality' ); ?></a>
				<?php
			endif;
