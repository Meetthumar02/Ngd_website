...
$install_by_plugin = get_option('country-code-install-by');
...
$form_elements = array(
    ...
    'whatsapp_redirect' => array(
        'label' => __('Whatsapp Redirect', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/whatsapp-icon-min.svg',
        'pro' => true
    ),

    'range_slider' => array(
        'label' => __('Range Slider', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/range-slider-min.svg',
        'pro' => true
    ),
    'calculator_field' => array(
        'label' => __('Calculator Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/calculator-field-min.svg',
        'pro' => true
    ),
    'rating_field' => array(
        'label' => __('Rating Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/rating-field-min.svg',
        'pro' => true
    ),
    'signature_field' => array(
        'label' => __('Signature Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/signature.svg',
        'pro' => true
    ),
    'image_radio' => array(
        'label' => __('Image Radio', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/image-radio-min.svg',
        'pro' => true
    ),
    'radio_checkbox_styler' => array(
        'label' => __('Radio & Checkbox Styler', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/radio-styler-min.svg',
        'pro' => true
    ),
    'label_styler' => array(
        'label' => __('Label Styler', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/label-style-min.svg',
        'pro' => true
    ),
    'select2' => array(
        'label' => __('Select2', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/select2-field-min.svg',
        'pro' => true
    ),
    'WYSIWYG' => array(
        'label' => __('WYSIWYG', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/WYSIWYG-min.svg',
        'pro' => true
    ),
    'confirm_dialog' => array(
        'label' => __('Confirm Dialog Box', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/dialog-box-min.svg',
        'pro' => true
    ),
    'restrict_date' => array(
        'label' => __('Restrict Date', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/restrict-date-min.svg',
        'pro' => true
    ),
    'currency_field' => array(
        'label' => __('Currency Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/currency-field-min.svg',
        'pro' => true
    ),
    'month_week_field' => array(
        'label' => __('Month/Week Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/month-week-field-min.svg',
        'pro' => true
    ),
    'cloudflare_recaptcha' => array(
        'label' => __('Cloudflare Turnstile', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/cloudflare-icon-min.svg',
        'pro' => true
    ),

    'h_recaptcha' => array(
        'label' => __('hCAPTCHA', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/hcaptcha-icon-min.svg',
        'pro' => true
    ),
    'toggle_field' => array(

        'label' => __('Toggle Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/toggle-field.svg',
        'pro' => true,
    ),


    'conditional_mailchimp' => array(
        'label' => __('Conditional MailChimp', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/mailchimp-logo.svg',
        'pro' => true,
...
$condition_plugin_features = array(
    'conditional_logic' => array(
        'label' => __('Conditional Logic', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/conditional-logic-1-min.svg'
    ),

    'submit_condition' => array(
        'label' => __('Submit Conditions', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/conditional-button-min.svg',
        'pro' => true
    ),


    'redirect_conditionaly' => array(
        'label' => __('Redirect Conditionaly', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/redirect-conditionally-min.svg',
        'pro' => true
    ),


    'email_conditionaly' => array(
        'label' => __('Email Conditionaly', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/conditional-email-1-min.svg',
        'pro' => true
    ...
    'multicondtion_or_logic' => array(
        'label' => __('Multiple OR Conditions', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/or-condition.svg',
        'pro' => true
    ...
    'more_operators' => array(
        'label' => __('More Operators', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/more-opreators.svg',
        'pro' => true
...
$country_field_features = array(
    'country_code' => array(
        'label' => __('Country code', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/country-code-min.svg'
    ),


    'country_state' => array(
        'label' => __('State Field', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/state-field.svg',
        'pro' => true
    ),

    'auto_select_country' => array(
        'label' => __('Auto Detect Country', 'country-code-field-for-elementor-form'),
        ...
        'demo' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://docs.coolplugins.net/plugin/cool-formkit-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard'),
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/auto-detect.svg',
        'pro' => true
...
$form_mask_features = array(
    'form_input_mask' => array(
        'label' => __('Field Masking', 'country-code-field-for-elementor-form'),
        ...
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/input-mask-min.svg'
    ),
    'hello_plus_support' => array(
        'label' => __('Hello Plus Support', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=', 'utm_source=' . $first_plugin, 'https://coolformkit.com/features/?utm_source=&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        'demo' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://docs.coolplugins.net/plugin/cool-formkit-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard'),
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/hello-plus-support.svg',
        'pro' => true
    ),

    'advanced_fields' => array(
        'label' => __('Advanced Fields', 'country-code-field-for-elementor-form'),
        'how_to' => str_replace('utm_source=', 'utm_source=' . $first_plugin, 'https://coolformkit.com/features/?utm_source=&utm_medium=inside&utm_campaign=demo&utm_content=dashboard'),
        'demo' => str_replace('utm_source=cfkef_plugin', 'utm_source=' . $first_plugin, 'https://docs.coolplugins.net/plugin/cool-formkit-for-elementor-form/?utm_source=cfkef_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard'),
        'icon' => CCFEF_PLUGIN_URL . 'assets/icons/advanced-field.svg',
        'pro' => true
    ),
...
$input_form_mask_features = array(
    'form_input_mask' => array(
        'label' => __('Input Mask', 'country-code-field-for-elementor-form'),
            ...
            <div class="cfk-plugins">
                <div class="cfk-box cfk-left">
                    ...
                    <div class="wrapper-header">
                        <div class="cfkef-save-all">
                            <div class="cfkef-title-desc">
                                <h2><?php esc_html_e('Conditional Fields For Elementor Form', 'country-code-field-for-elementor-form'); ?></h2>
                            </div>
                            <div class="cfkef-save-controls">
                                ...
                                if (!$is_condtional_field_active) {
                                    ...
                                    if ($is_conditional_field_installed) {
                                        ...
                                        echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-activate-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires Conditional Field plugin to be activated">' . esc_html__('Activate', 'country-code-field-for-elementor-form') . '</a>';
                                    } else if (!$is_conditional_field_installed) {

                                        echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-install-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires Conditional Field plugin to be install">' . esc_html__('Install', 'country-code-field-for-elementor-form') . '</a>';
                                    }
                                } else {
                                    ...
                                    ) . '" class="button">' . esc_html__('Get Pro', 'country-code-field-for-elementor-form') . '</a>';
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="wrapper-body">
                        ...
                        <div class="cfk-p-info">
                            <picture>
                                <source srcset="<?php //echo CCFEF_PLUGIN_URL . 'assets/images/placeholder.avif'; 
                                                ?>">
                                <img src="<?php echo esc_url(CCFEF_PLUGIN_URL . 'assets/images/conditional-fields.gif'); ?>">
                            </picture>
                                ...
                                <?php foreach ($condition_plugin_features as $key => $element): ?>
                                        ...
                                        <div class="cfkef-form-element-card">
                                            <div class="cfkef-form-element-info">
                                                ...
                                                <h4>
                                                    ...
                                                    <?php if (!empty($element['pro'])): ?>
                                                        <span class="cfkef-label-popular"><a href="<?php echo esc_url($element['how_to']) ?>" target="_blank"><?php esc_html_e('Pro', 'country-code-field-for-elementor-form'); ?></a></span>
                                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="cfkef-form-element-card<?php echo esc_attr($card_class); ?>"
                                            ...
                                            <?php if (!$is_condtional_field_active): ?>
                                                <div class="cfkef-tooltip"><?php esc_html_e('Requires Conditional Field plugin to be activated', 'country-code-field-for-elementor-form'); ?></div>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <div class="cfk-buttons">
                            <button type="submit" class="button button-primary "><?php esc_html_e('Save Changes', 'country-code-field-for-elementor-form'); ?></button>
                        </div>
                ...
                <div class="cfk-box cfk-middle">
                    ...
                    <div class="wrapper-header">
                        <div class="cfkef-save-all">
                            <div class="cfkef-title-desc">
                                <h2><?php esc_html_e('Country Code For Tel Field', 'country-code-field-for-elementor-form'); ?></h2>
                            </div>
                            <div class="cfkef-save-controls">
                                ...
                                if (!$is_country_field_active) {
                                    ...
                                    if ($is_country_field_installed) {
                                        ...
                                        echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-activate-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires Country Code Field plugin to be activated">' . esc_html__('Activate', 'country-code-field-for-elementor-form') . '</a>';
                                    } else if (!$is_country_field_installed) {

                                        echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-install-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires Country Code Field plugin to be install">' . esc_html__('Install', 'country-code-field-for-elementor-form') . '</a>';
                                    }
                                } else {
                    ...
                    <div class="wrapper-body">
                        ...
                        <div class="cfk-p-info">
                            <picture>
                                <!-- <source srcset="<?php echo esc_url(CCFEF_PLUGIN_URL . 'assets/images/country-code-field.avif'); ?>"> -->
                                <img src="<?php echo esc_url(CCFEF_PLUGIN_URL . 'assets/images/country-code-field.gif'); ?>">
                            </picture>
                            <div class="cfk-p-name">
                                ...
                                <?php foreach ($country_field_features as $key => $element): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="cfkef-form-element-card<?php echo esc_attr($card_class); ?>"
                                            ...
                                            <?php if (!$is_country_field_active): ?>
                                                <div class="cfkef-tooltip"><?php esc_html_e('Requires Country Code Field plugin to be activated', 'country-code-field-for-elementor-form'); ?></div>
                                            <?php endif; ?>
                                        </div>
                ...
                <?php if ($is_input_form_mask_installed && $is_input_form_mask_active): ?>
                    ...
                    <div class="cfk-box cfk-right">
                        <div class="wrapper-header">
                            <div class="cfkef-save-all">
                                <div class="cfkef-title-desc">
                                    <h2><?php esc_html_e('Input Mask Elementor Form Fields', 'country-code-field-for-elementor-form'); ?></h2>
                                </div>
                                <div class="cfkef-save-controls">
                        ...
                        <div class="wrapper-body">
                            ...
                            <div class="cfk-p-info">
                                <picture>
                                    <source srcset="<?php //echo CCFEF_PLUGIN_URL . 'assets/images/placeholder.avif'; 
                                                    ?>">
                                    <img src="<?php echo esc_url(CCFEF_PLUGIN_URL . 'assets/images/form-input-mask-icon.gif'); ?>">
                                </picture>
                                <div class="cfk-p-name">
                ...
                <?php else: ?>
                    ...
                    <div class="cfk-box cfk-right">
                        ...
                        <div class="wrapper-header">
                            <div class="cfkef-save-all">
                                <div class="cfkef-title-desc">
                                    <h2><?php esc_html_e('Form Input Masks for Elementor Form', 'country-code-field-for-elementor-form'); ?></h2>
                                </div>
                                <div class="cfkef-save-controls">
                                    ...
                                    if (!$is_form_mask_active) {
                                        ...
                                        if ($is_form_mask_installed) {
                                            ...
                                            echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-activate-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires form mask plugin to be activated">' . esc_html__('Activate', 'country-code-field-for-elementor-form') . '</a>';
                                        } else if (!$is_form_mask_installed) {

                                            echo '<a target="_blank" class="button need-activation  cfkef-has-tooltip cfkef-install-plugin-btn" data-action="' . esc_attr($data_action) . '" data-slug="' . esc_attr($data_slug) . '" data-init="' . esc_attr($data_init) . '" title="Requires form mask plugin to be install">' . esc_html__('Install', 'country-code-field-for-elementor-form') . '</a>';
                                        }
                                    } else {
                                    ...
                                    <?php foreach ($form_mask_features as $key => $element): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="cfkef-form-element-card<?php echo esc_attr($card_class); ?>"
                                                ...
                                                <?php if (!$is_form_mask_active): ?>
                                                    <div class="cfkef-tooltip"><?php esc_html_e('Requires form mask plugin to be install', 'country-code-field-for-elementor-form'); ?></div>
                                                <?php endif; ?>
                                            </div>
            ...
            <div class="cfk-promo">
                <div class="cfk-box cfk-left">
                    ...
                    <div class="wrapper-header">
                        <div class="cfkef-save-all">
                            <div class="cfkef-title-desc">
                                <h2><?php esc_html_e('What is Cool FormKit?', 'country-code-field-for-elementor-form'); ?></h2>
                            </div>
