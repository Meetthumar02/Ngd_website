...
// 	echo '<style>
// 		iframe[style*="width:64px"][style*="height:60px"] {
...
// 			var iframes = document.querySelectorAll(\'iframe[style*="width:64px"][style*="height:60px"], iframe[style*="width: 64px"][style*="height: 60px"]\');
// 			iframes.forEach(function(iframe) {
// 				iframe.style.setProperty("bottom", "55px", "important");
// 			});
// 				iframes.forEach(function(iframe) {
// 				iframe.style.setProperty("right", "2px", "important");
// 			});
// 		}
// 		var observer = new MutationObserver(fixTawkPosition);
// 		observer.observe(document.body, { attributes: true, childList: true, subtree: true });
// 		setInterval(fixTawkPosition, 500);
// 	})();
// 	</script>';
// }, 999 );
add_action( 'wp_footer', function() {
	...
	(function() {
		...
		new MutationObserver(fixTawkPosition).observe(document.body, {
			childList: true,
			subtree: true,
			attributes: true
		});
